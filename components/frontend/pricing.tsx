      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="">
          <SectionHeader
            ...
            description="Simple predictable pricing that grows with your institution. All features included, no hidden fees special discounts available for large institution."
          />
        </div>
